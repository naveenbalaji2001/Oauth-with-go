...
// @title Spotify API
// @version 1.0
// @description This is a simple example of a Golang application using Gin and GORM to interact with the Spotify API.
// @host localhost:8080
// @BasePath /
...
// authenticateSpotify authenticates with Spotify and returns a Spotify client
